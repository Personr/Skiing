#ifndef SLALOM_RENDERABLE_HPP
#define SLALOM_RENDERABLE_HPP
/**@file
 * @brief Define a class to render the world frame.
 *
 * This file defines the class SlalomRenderable to render the world frame.
 */
...
class SlalomRenderable : public Renderable
{
...
typedef std::shared_ptr<SlalomRenderable> SlalomRenderablePtr;
