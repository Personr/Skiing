#ifndef SKIER_RENDERABLE_HPP
#define SKIER_RENDERABLE_HPP
 ...
 */
class SkierRenderable : public HierarchicalRenderable
{
    public:
...
typedef std::shared_ptr<SkierRenderable> SkierRenderablePtr;

#endif //SKIER_RENDERABLE_HPP
