#ifndef STICK_RENDERABLE_HPP
#define STICK_RENDERABLE_HPP
 ...
 */
class StickRenderable : public HierarchicalRenderable
{
    public:
         ...
         */
        StickRenderable(ShaderProgramPtr program, glm::vec3 color);
...
typedef std::shared_ptr<StickRenderable> StickRenderablePtr;
